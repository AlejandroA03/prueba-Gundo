      ...
      <form onSubmit={submitHandler} className="rounded-xl bg-gray-800 w-96 relative p-10 mb-32">
        <div>
          ...
          <div>
            ...
            <input type="string" name="username" id="username" value={userData.username} required onChange={inputHandler} className="block bg-gray-900 rounded-lg p-3 text-sm my-3 w-full px-5" />
          </div>
          <div>
